package com.sap.xsk.xscjob.ds.scheduler.handler;
...
public class XSKJobHandler implements Job {
    ...
    private XSKJavascriptEngineExecutor xscJavascriptEngineExecutor = StaticInjector.getInjector().getInstance(XSKJavascriptEngineExecutor.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            xscJavascriptEngineExecutor.executeService(module, executionContext, true);
