...
public class XSKSecureStoreSynchronizerJobDefinitionProvider implements IJobDefinitionProvider {
	...
	private static final String XSK_SECURE_STORE_SYNCHRONIZER_JOB = "XSK Secure Store Synchronizer Job";
	private static final String DIRIGIBLE_INTERNAL_XSK_SECURE_CREATE_SECURE_STORE_VALUE_SYNCHRONIZER_JOB = "dirigible-internal-xsc-secure-createSecureStoreValue-synchronizer-job";
