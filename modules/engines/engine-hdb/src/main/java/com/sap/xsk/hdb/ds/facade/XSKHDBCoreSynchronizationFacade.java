...
public class XSKHDBCoreSynchronizationFacade implements IXSKHDBCoreSynchronizationFacade {
  ...
  public void updateEntities() {
    Map<String, XSKDataStructureModel> dataStructureCdsModels = managerServices.get(IXSKDataStructureModel.TYPE_HDBDD)
        .getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureTablesModels = managerServices.get(IXSKDataStructureModel.TYPE_HDB_TABLE)
        .getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureViewsModels = managerServices.get(IXSKDataStructureModel.TYPE_HDB_VIEW)
        .getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureProceduresModels = managerServices.get(IXSKDataStructureModel.TYPE_HDB_PROCEDURE)
        .getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureTableFunctionsModels = managerServices.get(
        IXSKDataStructureModel.TYPE_HDB_TABLE_FUNCTION).getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureScalarFunctionsModels = managerServices.get(
        IXSKDataStructureModel.TYPE_HDB_SCALAR_FUNCTION).getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureSchemasModels = managerServices.get(IXSKDataStructureModel.TYPE_HDB_SCHEMA)
        .getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureSynonymModels = managerServices.get(IXSKDataStructureModel.TYPE_HDB_SYNONYM)
        .getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureSequencesModels = managerServices.get(IXSKDataStructureModel.TYPE_HDB_SEQUENCE)
        .getDataStructureModels();
    Map<String, XSKDataStructureModel> dataStructureTableTypesModels = managerServices.get(IXSKDataStructureModel.TYPE_HDB_TABLE_TYPE)
        .getDataStructureModels();
    ...
    for (XSKDataStructureModel cds : dataStructureCdsModels.values()) {
      ((XSKDataStructureCdsModel) cds).getTableModels().stream()
          .forEach(tableModel -> XSK_DATA_STRUCTURE_MODELS.put(tableModel.getName(), tableModel));

      ((XSKDataStructureCdsModel) cds).getTableTypeModels().stream()
          .forEach(tableTypeModel -> XSK_DATA_STRUCTURE_MODELS.put(tableTypeModel.getName(), tableTypeModel));

      ((XSKDataStructureCdsModel) cds).getViewModels().stream()
          .forEach(viewModel -> XSK_DATA_STRUCTURE_MODELS.put(viewModel.getName(), viewModel));
    }
    ...
    try {
      try (Connection connection = dataSource.getConnection()) {
        ...
        if (!hdiOnly) {
          ...
          // drop HDB Procedures
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_PROCEDURE_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_PROCEDURE_DROP.toString(),
                PROCEDURE_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_FUNCTION_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_FUNCTION_DROP.toString(),
                TABLE_FUNCTION_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_SCALAR_FUNCTION_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_SCALAR_FUNCTION_DROP.toString(),
                SCALAR_FUNCTION_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_SYNONYM_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_SYNONYM_DROP.toString(),
                SYNONYM_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_VIEW_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_VIEW_DROP.toString(), VIEW_SYNCHRONIZATION_ARTEFACT_TYPE,
                ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_DROP.toString(),
                TABLE_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_TYPE_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_TYPE_DROP.toString(),
                TABLE_TYPE_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_SCHEMA_DROP.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_SCHEMA_DROP.toString(),
                SCHEMA_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_SCHEMA_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_SCHEMA_CREATE.toString(),
                SCHEMA_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_TYPE_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_TYPE_CREATE.toString(),
                TABLE_TYPE_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_CREATE.toString(),
                TABLE_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_VIEW_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_VIEW_CREATE.toString(),
                VIEW_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_SYNONYM_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_SYNONYM_CREATE.toString(),
                SYNONYM_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_SEQUENCE_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_SEQUENCE_CREATE.toString(),
                SEQUENCE_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          }
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_PROCEDURE_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_PROCEDURE_CREATE.toString(),
                PROCEDURE_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_FUNCTION_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_TABLE_FUNCTION_CREATE.toString(),
                TABLE_FUNCTION_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
          ...
          try {
            List<XSKTopologyDataStructureModelWrapper> results = depleter.deplete(list,
                XSKTopologyDataStructureModelEnum.EXECUTE_SCALAR_FUNCTION_CREATE.toString());
            printErrors(errors, results, XSKTopologyDataStructureModelEnum.EXECUTE_SCALAR_FUNCTION_CREATE.toString(),
                SCALAR_FUNCTION_SYNCHRONIZATION_ARTEFACT_TYPE, ArtefactState.FAILED_DELETE);
          } catch (Exception e) {
            logger.error(e.getMessage(), e);
            errors.add(e.getMessage());
