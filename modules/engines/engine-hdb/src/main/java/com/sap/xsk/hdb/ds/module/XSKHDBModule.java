...
public class XSKHDBModule extends AbstractDirigibleModule {
  ...
  private void bindProcessors() {
    ...
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("xskEntityUpdateProcessor")).to(XSKEntityUpdateProcessor.class)
        .in(Scopes.SINGLETON);
    ...
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("xskEntityCreateProcessor")).to(XSKEntityCreateProcessor.class)
        .in(Scopes.SINGLETON);

    // Hdb procedure processors instantiation
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("hdbProcedureDropProcessor")).to(HDBProcedureDropProcessor.class)
        .in(Scopes.SINGLETON);
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("hdbProcedureCreateProcessor")).to(HDBProcedureCreateProcessor.class)
        .in(Scopes.SINGLETON);

    // Hdb schema processors instantiation
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("hdbSchemaCreateProcessor")).to(HDBSchemaCreateProcessor.class)
        .in(Scopes.SINGLETON);
    ...
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("hdbTableFunctionCreateProcessor")).to(HDBTableFunctionCreateProcessor.class)
        .in(Scopes.SINGLETON);
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("hdbTableFunctionDropProcessor")).to(HDBTableFunctionDropProcessor.class)
        .in(Scopes.SINGLETON);
    ...
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("xskSynonymCreateProcessor")).to(HDBSynonymCreateProcessor.class)
        .in(Scopes.SINGLETON);
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("xskSynonymDropProcessor")).to(HDBSynonymDropProcessor.class)
        .in(Scopes.SINGLETON);

    // Hdb sequence processors instantiation
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("xskHdbSequenceUpdateProcessor")).to(XSKHDBSequenceUpdateProcessor.class)
        .in(Scopes.SINGLETON);
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("xskHdbSequenceDropProcessor")).to(XSKHDBSequenceDropProcessor.class)
        .in(Scopes.SINGLETON);
    bind(IXSKHdbProcessor.class).annotatedWith(Names.named("xskHdbSequenceCreateProcessor")).to(XSKHDBSequenceCreateProcessor.class)
        .in(Scopes.SINGLETON);
