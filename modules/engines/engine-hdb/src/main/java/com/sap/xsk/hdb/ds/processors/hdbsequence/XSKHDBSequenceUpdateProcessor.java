...
public class XSKHDBSequenceUpdateProcessor extends AbstractXSKProcessor<XSKDataStructureHDBSequenceModel> {
  ...
  public void execute(Connection connection, XSKDataStructureHDBSequenceModel hdbSequenceModel) throws SQLException {
    ...
    switch (hdbSequenceModel.getDBContentType()) {
      ...
      case OTHERS: {
        ...
        if (dialect.getClass().equals(HanaSqlDialect.class)) {
          ...
          dataStructuresSynchronizer.applyArtefactState(hdbSequenceModel.getName(), hdbSequenceModel.getLocation(), SEQUENCE_ARTEFACT, ArtefactState.FAILED_UPDATE, errorMessage);
    ...
    try {
      ...
      dataStructuresSynchronizer.applyArtefactState(hdbSequenceModel.getName(), hdbSequenceModel.getLocation(), SEQUENCE_ARTEFACT, ArtefactState.SUCCESSFUL_UPDATE, message);
      ...
      dataStructuresSynchronizer.applyArtefactState(hdbSequenceModel.getName(), hdbSequenceModel.getLocation(), SEQUENCE_ARTEFACT, ArtefactState.FAILED_UPDATE, message);
    }
  }
