  ...
  public void execute(Connection connection, XSKDataStructureHDBTableFunctionModel hdbTableFunction)
    ...
    if (SqlFactory.getNative(connection)
      ...
      if (!(dialect.getClass().equals(HanaSqlDialect.class))) {
        ...
        dataStructuresSynchronizer.applyArtefactState(hdbTableFunction.getName(),hdbTableFunction.getLocation(),TABLE_FUNCTION_ARTEFACT, ArtefactState.FAILED_DELETE, errorMessage);
        ...
        try {
          ...
          dataStructuresSynchronizer.applyArtefactState(hdbTableFunction.getName(), hdbTableFunction.getLocation(), TABLE_FUNCTION_ARTEFACT, ArtefactState.SUCCESSFUL_DELETE, message);
      ...
      dataStructuresSynchronizer.applyArtefactState(hdbTableFunction.getName(), hdbTableFunction.getLocation(), TABLE_FUNCTION_ARTEFACT, ArtefactState.FAILED_DELETE, warningMessage);
    }
  }
