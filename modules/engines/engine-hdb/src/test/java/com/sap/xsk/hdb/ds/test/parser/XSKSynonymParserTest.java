...
public class XSKSynonymParserTest extends AbstractDirigibleTest {
	...
	public void parseHdbsynonymFileWithoutErrorsSuccessfully() throws Exception {
		String hdbsynonymSample = IOUtils.toString(XSKSynonymParserTest.class.getResourceAsStream("/MySynonym.hdbsynonym"), StandardCharsets.UTF_8);
	...
	public void parseHdbsynonymFileMissingTargetSchemaFailed() throws Exception {
		...
		XSKDataStructureParametersModel parametersModel = new XSKDataStructureParametersModel(null, "hdb_view/MySynonym.hdbsynonym", content, null);

		XSKSynonymParser parser = Mockito.mock(XSKSynonymParser.class);
