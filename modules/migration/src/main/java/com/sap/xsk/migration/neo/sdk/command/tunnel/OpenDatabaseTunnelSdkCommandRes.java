...
public class OpenDatabaseTunnelSdkCommandRes implements SdkCommandRes {
  ...
  public OpenDatabaseTunnelSdkCommandRes(String host, int port, String dbType, String jdbcUrl, String instanceNumber,
      String dbUser, String dbSchema, String sessionId) {
    this.host = host;
    this.port = port;
    this.dbType = dbType;
