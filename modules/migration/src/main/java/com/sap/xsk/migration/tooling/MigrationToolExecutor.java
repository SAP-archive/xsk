...
public class MigrationToolExecutor {
  ...
  public MigrationToolExecutor(SystemProcessBuilder systemProcessBuilder) {
  ...
  private File createProcessDirectory(String toolDirectory) {
    String catalinaHome = Configuration.get("CATALINA_HOME");
