...
package com.sap.ndb.datamodel.filter;
 ...
 * generated in the com.sap.ndb.datamodel.filter package.
...
public class ObjectFactory {
  ...
  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sap.ndb.datamodel.filter
   */
