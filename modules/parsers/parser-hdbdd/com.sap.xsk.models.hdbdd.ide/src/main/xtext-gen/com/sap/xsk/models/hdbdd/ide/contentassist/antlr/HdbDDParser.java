...
import com.sap.xsk.models.hdbdd.ide.contentassist.antlr.internal.InternalHdbDDParser;
import com.sap.xsk.models.hdbdd.services.HdbDDGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class HdbDDParser extends AbstractContentAssistParser {
  ...
  @Override
  protected InternalHdbDDParser createParser() {
    InternalHdbDDParser result = new InternalHdbDDParser(null);
  ...
  public static final class NameMappings {
    ...
    @Inject
    public NameMappings(HdbDDGrammarAccess grammarAccess) {
      ImmutableMap.Builder<AbstractElement, String> builder = ImmutableMap.builder();
      init(builder, grammarAccess);
      this.mappings = builder.build();
    }

    private static void init(ImmutableMap.Builder<AbstractElement, String> builder, HdbDDGrammarAccess grammarAccess) {
      ...
      builder
          .put(grammarAccess.getTypeDefinitionAccess().getFieldLengthAssignment_4_1(), "rule__TypeDefinition__FieldLengthAssignment_4_1");
      ...
      builder
          .put(grammarAccess.getFieldPrimitiveAccess().getFieldLengthAssignment_4_1(), "rule__FieldPrimitive__FieldLengthAssignment_4_1");
      builder.put(grammarAccess.getFieldPrimitiveAccess().getFieldPredefinedTypeAssignment_5(),
      ...
      builder
          .put(grammarAccess.getFieldTypeAccess().getFieldPredefinedTypeAssignment_3(), "rule__FieldType__FieldPredefinedTypeAssignment_3");
      builder.put(grammarAccess.getFieldReferenceAccess().getNameAssignment_0(), "rule__FieldReference__NameAssignment_0");
      builder
          .put(grammarAccess.getFieldReferenceAccess().getReferenceTypeAssignment_2(), "rule__FieldReference__ReferenceTypeAssignment_2");
      builder.put(grammarAccess.getFieldReferenceAccess().getFieldReferenceEntityAssignment_5(),
          "rule__FieldReference__FieldReferenceEntityAssignment_5");
      builder.put(grammarAccess.getFieldReferenceAccess().getFieldReferenceEntityLocalIdAssignment_7(),
          "rule__FieldReference__FieldReferenceEntityLocalIdAssignment_7");
      builder.put(grammarAccess.getFieldReferenceAccess().getFieldReferenceEntityForeignIdAssignment_9(),
