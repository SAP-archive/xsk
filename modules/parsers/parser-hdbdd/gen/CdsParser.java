...
public class CdsParser extends Parser {
	...
	public static class TopLevelSymbolContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CdsVisitor ) return ((CdsVisitor<? extends T>)visitor).visitTopLevelSymbol(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AssignHanaTypeWithArgsContext extends TypeAssignRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CdsVisitor ) return ((CdsVisitor<? extends T>)visitor).visitAssignHanaTypeWithArgs(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AssignHanaTypeContext extends TypeAssignRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CdsVisitor ) return ((CdsVisitor<? extends T>)visitor).visitAssignHanaType(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ElementDetailsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CdsVisitor ) return ((CdsVisitor<? extends T>)visitor).visitElementDetails(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ArtifactRuleContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CdsVisitor ) return ((CdsVisitor<? extends T>)visitor).visitArtifactRule(this);
			else return visitor.visitChildren(this);
		}
	}
