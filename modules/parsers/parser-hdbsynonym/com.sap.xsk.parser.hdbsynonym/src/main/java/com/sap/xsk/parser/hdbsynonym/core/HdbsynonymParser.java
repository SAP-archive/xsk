...
public class HdbsynonymParser extends Parser {
  ...
  public static class HdbsynonymDefinitionContext extends ParserRuleContext {
    ...
    public TerminalNode COLON() {
      return getToken(HdbsynonymParser.COLON, 0);
    }
    ...
    public int getRuleIndex() {
      return RULE_hdbsynonymDefinition;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).enterHdbsynonymDefinition(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).exitHdbsynonymDefinition(this);
      }
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HdbsynonymVisitor) {
        return ((HdbsynonymVisitor<? extends T>) visitor).visitHdbsynonymDefinition(this);
      } else {
  ...
  public static class LocationContext extends ParserRuleContext {
    ...
    public TerminalNode STRING() {
      return getToken(HdbsynonymParser.STRING, 0);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).enterLocation(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).exitLocation(this);
      }
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HdbsynonymVisitor) {
        return ((HdbsynonymVisitor<? extends T>) visitor).visitLocation(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class SynonymBodyContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_synonymBody;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).enterSynonymBody(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).exitSynonymBody(this);
      }
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HdbsynonymVisitor) {
        return ((HdbsynonymVisitor<? extends T>) visitor).visitSynonymBody(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class SynonymTargetContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_synonymTarget;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).enterSynonymTarget(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).exitSynonymTarget(this);
      }
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HdbsynonymVisitor) {
        return ((HdbsynonymVisitor<? extends T>) visitor).visitSynonymTarget(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class SynonymTargetPropContext extends ParserRuleContext {
    ...
    public TerminalNode COMMA() {
      return getToken(HdbsynonymParser.COMMA, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_synonymTargetProp;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).enterSynonymTargetProp(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).exitSynonymTargetProp(this);
      }
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HdbsynonymVisitor) {
        return ((HdbsynonymVisitor<? extends T>) visitor).visitSynonymTargetProp(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class SynonymSchemaContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_synonymSchema;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).enterSynonymSchema(this);
      }
    }
    ...
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof HdbsynonymListener) {
        ((HdbsynonymListener) listener).exitSynonymSchema(this);
      }
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof HdbsynonymVisitor) {
        return ((HdbsynonymVisitor<? extends T>) visitor).visitSynonymSchema(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
