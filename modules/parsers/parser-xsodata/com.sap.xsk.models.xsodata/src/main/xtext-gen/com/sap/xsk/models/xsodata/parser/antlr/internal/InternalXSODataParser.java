...
public class InternalXSODataParser extends AbstractInternalAntlrParser {
  ...
  public static final String[] tokenNames = new String[]{
      ...
      "RULE_ANY_OTHER", "'service'", "'namespace'", "'{'", "'}'", "'.'", "'::'", "'as'", "';'", "'navigates'", "'('", "')'", "'create'",
      "'events'", "'before'", "'.xsjs'", "':'", "'.xsjslib'", "'delete'", "'using'", "'update'", "'forbidden'", "'association'",
      "'principal'", "'multiplicity'", "'dependent'", "'*'", "'1'"
  };
  ...
  public String[] getTokenNames() {
    return InternalXSODataParser.tokenNames;
  }
