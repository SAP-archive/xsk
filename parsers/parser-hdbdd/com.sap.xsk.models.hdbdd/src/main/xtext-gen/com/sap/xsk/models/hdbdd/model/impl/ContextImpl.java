 ...
 * </p>
 * <ul>
 *   <li>{@link com.sap.xsk.models.hdbdd.model.impl.ContextImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link com.sap.xsk.models.hdbdd.model.impl.ContextImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends TypeImpl implements Context
{
  ...
  public EList<TypeDefinition> getTypes()
  {
    if (types == null)
    {
      types = new EObjectContainmentEList<TypeDefinition>(TypeDefinition.class, this, ModelPackage.CONTEXT__TYPES);
    }
    return types;
  }
  ...
  public EList<Entity> getEntities()
  {
    if (entities == null)
    {
      entities = new EObjectContainmentEList<Entity>(Entity.class, this, ModelPackage.CONTEXT__ENTITIES);
    }
    return entities;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ModelPackage.CONTEXT__TYPES:
        return ((InternalEList<?>)getTypes()).basicRemove(otherEnd, msgs);
      case ModelPackage.CONTEXT__ENTITIES:
