...
var schema = "DBADMIN";
var PRODUCTS_TABLE = "product_project.db::Products.Orders";
var ITEMS_TABLE = "product_project.db::Products.Item";
...
function deleteOrder(paramObject) {
	try {
		...
		var sQuery = 'delete from "ADMIN"."product_project.db::Products.Orders" where "Id" = (select "Id" from "' + paramObject.beforeTableName +
			'")';
