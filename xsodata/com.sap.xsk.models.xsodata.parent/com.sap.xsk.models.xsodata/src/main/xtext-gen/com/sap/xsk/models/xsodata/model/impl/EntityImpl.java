 ...
 * </p>
 * <ul>
 *   <li>{@link com.sap.xsk.models.xsodata.model.impl.EntityImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link com.sap.xsk.models.xsodata.model.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.sap.xsk.models.xsodata.model.impl.EntityImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link com.sap.xsk.models.xsodata.model.impl.EntityImpl#getNavigates <em>Navigates</em>}</li>
 *   <li>{@link com.sap.xsk.models.xsodata.model.impl.EntityImpl#getCreateEvents <em>Create Events</em>}</li>
 *   <li>{@link com.sap.xsk.models.xsodata.model.impl.EntityImpl#getDeleteUsing <em>Delete Using</em>}</li>
 *   <li>{@link com.sap.xsk.models.xsodata.model.impl.EntityImpl#getUpdate <em>Update</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity
{
  ...
  public void setAlias(String newAlias)
  {
    ...
    alias = newAlias;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENTITY__ALIAS, oldAlias, alias));
  }
  ...
  public EList<Navigation> getNavigates()
  {
    if (navigates == null)
    {
      navigates = new EObjectContainmentEList<Navigation>(Navigation.class, this, ModelPackage.ENTITY__NAVIGATES);
    }
    return navigates;
  }
  ...
  public EList<String> getCreateEvents()
  {
    ...
    {
      createEvents = new EDataTypeEList<String>(String.class, this, ModelPackage.ENTITY__CREATE_EVENTS);
    }
    return createEvents;
  }
  ...
  public EList<String> getDeleteUsing()
  {
    if (deleteUsing == null)
    {
      deleteUsing = new EDataTypeEList<String>(String.class, this, ModelPackage.ENTITY__DELETE_USING);
    }
    return deleteUsing;
  }
  ...
  public EList<String> getUpdate()
  {
    if (update == null)
    {
      update = new EDataTypeEList<String>(String.class, this, ModelPackage.ENTITY__UPDATE);
    }
    return update;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ModelPackage.ENTITY__NAVIGATES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ModelPackage.ENTITY__NAME:
        return getName();
      case ModelPackage.ENTITY__ALIAS:
        return getAlias();
      case ModelPackage.ENTITY__NAVIGATES:
        return getNavigates();
      case ModelPackage.ENTITY__CREATE_EVENTS:
        return getCreateEvents();
      case ModelPackage.ENTITY__DELETE_USING:
        return getDeleteUsing();
      case ModelPackage.ENTITY__UPDATE:
        return getUpdate();
    }
